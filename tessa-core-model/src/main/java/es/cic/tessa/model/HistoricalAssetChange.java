...
public class HistoricalAssetChange implements Comparable<HistoricalAssetChange>, Serializable
{
    ...
    public HistoricalAssetChange(Asset asset, LocalDateTime startChange, LocalDateTime endChange, String historicalChangeOperation)
    {
    ...
    @Override
    public int compareTo(HistoricalAssetChange historicalChange)
    {
	...
	return "HistoricalChange [abstractElement=" + asset + ", startChange=" + startChange + ", endChange=" + endChange + "]";
    }
	...
	if(getClass() != obj.getClass())
	    return false;
	HistoricalAssetChange other = (HistoricalAssetChange) obj;
