...
public class HistoricalTemplateAttributeCollectionMappingChange implements Comparable<HistoricalTemplateAttributeCollectionMappingChange>, Serializable
{
    ...
    public HistoricalTemplateAttributeCollectionMappingChange(TemplateAttributeCollectionMapping templateAttributeCollectionMapping, LocalDateTime startChange, LocalDateTime endChange, String historicalChangeOperation)
    {
    ...
    @Override
    public int compareTo(HistoricalTemplateAttributeCollectionMappingChange historicalChange)
    {
	...
	return "HistoricalTemplateAttributeCollectionMappingChange [abstractElement=" + templateAttributeCollectionMapping + ", startChange=" + startChange + ", endChange=" + endChange + "]";
    }
	...
	if(getClass() != obj.getClass())
	    return false;
	HistoricalTemplateAttributeCollectionMappingChange other = (HistoricalTemplateAttributeCollectionMappingChange) obj;
