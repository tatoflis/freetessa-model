...
public class HistoricalTemplateAttributeChange implements Comparable<HistoricalTemplateAttributeChange>, Serializable
{
    ...
    public HistoricalTemplateAttributeChange(TemplateAttribute templateAttribute, LocalDateTime startChange, LocalDateTime endChange, String historicalChangeOperation)
    {
    ...
    @Override
    public int compareTo(HistoricalTemplateAttributeChange historicalChange)
    {
	...
	return "HistoricalTemplateAttributeChange [abstractElement=" + templateAttribute + ", startChange=" + startChange + ", endChange=" + endChange + "]";
    }
	...
	if(getClass() != obj.getClass())
	    return false;
	HistoricalTemplateAttributeChange other = (HistoricalTemplateAttributeChange) obj;
