...
public class HistoricalOrganizerChange implements Comparable<HistoricalOrganizerChange>, Serializable
{
    ...
    public HistoricalOrganizerChange(Organizer organizer, LocalDateTime startChange, LocalDateTime endChange, String historicalChangeOperation)
    {
    ...
    @Override
    public int compareTo(HistoricalOrganizerChange historicalChange)
    {
	...
	return "HistoricalOrganizerChange [abstractElement=" + organizer + ", startChange=" + startChange + ", endChange=" + endChange + "]";
    }
	...
	if(getClass() != obj.getClass())
	    return false;
	HistoricalOrganizerChange other = (HistoricalOrganizerChange) obj;
