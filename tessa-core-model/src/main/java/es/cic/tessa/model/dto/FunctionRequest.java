...
public class FunctionRequest implements Serializable
{
	...
	return "FunctionRequest [expressionFunction=" + expressionFunction + ", refillingCalculation=" + refillingCalculation + ", ignoreNoData=" + ignoreNoData + ", cronExpression=" + cronExpression + ", expressionEvent=" + expressionEvent + ", cronTimeZone=" + cronTimeZone + ", cronDelay=" + cronDelay + "]";
    }
