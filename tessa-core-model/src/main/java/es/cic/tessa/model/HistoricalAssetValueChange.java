...
public class HistoricalAssetValueChange implements Comparable<HistoricalAssetValueChange>, Serializable
{
    ...
    public HistoricalAssetValueChange(AssetValue assetValue, LocalDateTime startChange, LocalDateTime endChange, String historicalChangeOperation)
    {
    ...
    @Override
    public int compareTo(HistoricalAssetValueChange historicalChange)
    {
	...
	return "HistoricalAssetValueChange [abstractElement=" + assetValue + ", startChange=" + startChange + ", endChange=" + endChange + "]";
    }
	...
	if(getClass() != obj.getClass())
	    return false;
	HistoricalAssetValueChange other = (HistoricalAssetValueChange) obj;
